# Отток клиентов банка (EDA and Random Forest)
...
|-------------|-------------|-------------|-------------|
|  accuracy_score | 0.8679	| 0.5988	| -0.2691|
|  precision_score  | 0.7702	| 0.3277	| -0.4425|
|  recall_score  | 0.4588	| 0.9198	| 0.4610|
|  f1_score  | 0.5750	| 0.4832	| -0.0918|
|  roc_auc_score  | 0.8643	|0.8461	| -0.0182|
...
- При этом, мы заплатили снижением Precision (с 0.77 до 0.33), что оправдано целью: находить больше уходящих клиентов.  
- f1_score упал с 0.58 до 0.48. Падение на 0.1 - приемлемая плата за удвоение Recall.  
- ROC-AUC упал незначительно. Модель все также хорошо разделяет классы. Но за счет того, что порог решающего правила был уменьшен и смещен в сторону Recall, Recall существенно вырос.  
